    ...
    public class ProvideAttackSystem : BaseEcsVisitable, IEcsRunSystem
    {
        ...
        public void Run(IEcsSystems systems)
        {
            ...
            foreach (var targetProvideAttackRequestEntity in _provideAttackRequestFilter.Value)
            {
                ...
                var attackSpeed = _unitStatsPool.Value.Get(targetEntity).AttackSpeed;
                ...
                inAttackComp.End = _cachedTime + animationDuration;
                ...
                if (_animancerPool.Value.Has(targetEntity))
                {
                    ...
                    var state = animancerComp.Value.Play(targetProvideAttackRequest.AttackConfig.AttackAnimation);
                    state.Time = 0;
