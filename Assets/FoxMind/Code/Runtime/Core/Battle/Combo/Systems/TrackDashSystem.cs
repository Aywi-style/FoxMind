...
{
    public class TrackDashSystem : BaseEcsVisitable, IEcsRunSystem
    {
        private readonly EcsWorldInject _world = default;
        private readonly EcsFilterInject<Inc<BaseInputControlsComp, InputDashEvent>> _inputDashFilter = default;
        private readonly EcsFilterInject<Inc<PlayerControlledComp, CombinableComp, InputtedDashComp>> _comboFilter = default;
